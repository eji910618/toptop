    ...
    <t:putAttribute name="content">
        ...
        <section id="container">
            ...
            <c:if test="${!empty hotissueBanner.resultList}">
                <section class="main_rolling" style="height: 600px;">
                    <ul class="bxslider main_visual">
            	...
            	<div class="inner">
	                <h2 class="title_h2">
	                    <span>
	                        ...
	                        <i><a href="https://www.instagram.com/${instagramVo.data.instagramAct}" target="_blank">@edition_sensibility</a></i>
	                    </span>
	                </h2>
