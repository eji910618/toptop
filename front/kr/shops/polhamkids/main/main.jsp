...
<t:insertDefinition name="defaultLayout">
    ...
    <t:putAttribute name="style">
        ...
        <link rel="stylesheet" href="/front/css/polhamkids/main.css?v=2">
    </t:putAttribute>
    ...
    <t:putAttribute name="content">
        ...
        <section id="container">
            ...
            <c:if test="${!empty subVisualBanner.resultList}">
                <section class="main_suggest">
                    <c:forEach var="item" items="${subVisualBanner.resultList}" varStatus="status">
                        ...
                        <div>
                            <span class="img">
                                <a href="${visualLinkUrl}" ${visualTarget}><img src="<spring:eval expression="@system['system.cdn.path']" />/${item.partnerId}/image/banner/${item.filePath1}/${item.fileNm1}?AR=0&RS=590x388" alt=""></a>
                            </span>
                            <div class="suggest">
                                <div class="tit">
            ...
            <section class="main_feature">
                <div class="man">
                	<div class="title_h2"><span>BOY</span></div>
                	<div class="rolling">
	                    <ul>
                ...
                <div class="woman">
                	<div class="title_h2"><span>GIRL</span></div>
                	<div class="rolling">
	                    <ul>
	                        <li><a href="#" class="on">NEW</a></li>
	                        <li><a href="#">BEST</a></li>
