...
<%
	...
	String param_cancelReturnUrl	= request.getParameter("cancelReturnUrl");	// [필수] 해지처리 결과전달 URL - (URL Encoding 대상필드)
	...
	// 결제요청 URL
	String requestURL = requestDomain + "/stdwpay/su/mypage";	// 테스트계
	...
	try {
		...
		// URL Encoding
		param_cancelReturnUrl = CustomStringUtils.urlEncode(param_cancelReturnUrl, "UTF-8");
...
<form id="SendPayForm_id" name="SendPayForm" method="POST" >
	...
	<!-- <br/><b>returnUrl</b> -->
	<br/><input type="hidden"   name="cancelReturnUrl" value="<%=param_cancelReturnUrl%>" >
