...
<t:insertDefinition name="defaultLayout">\
    ...
    <t:putAttribute name="title">${pageNm}</t:putAttribute>
    ...
    <section id="container" class="sub aside pt60">
        <div class="inner">
            <section id="mypage" class="sub shopping">
                        ...
                        <tr>
                            <td class="ta_l bl0">
                                ...
                                <div class="o-goods-info">
                                    <a href="<goods:link siteNo="${orderGoodsVO.siteNo}" partnerNo="${orderGoodsVO.partnerNo}" url="/front/goods/goodsDetail.do?goodsNo=${orderGoodsVO.goodsNo}" />" class="thumb"><img src="${orderGoodsVO.goodsDispImgC}" alt="${orderGoodsVO.goodsNm}" /></a>
                                    <div class="thumb-etc">
                               ...
                               <c:if test="${!empty orderGoodsVO.goodsSetList}">
                                   ...
                                   <c:forEach var="orderGoodsSetList" items="${orderGoodsVO.goodsSetList}">
                                       <div class="o-goods-info">
                                           <a href="<goods:link siteNo="${orderGoodsVO.siteNo}" partnerNo="${orderGoodsVO.partnerNo}" url="/front/goods/goodsDetail.do?goodsNo=${orderGoodsVO.goodsNo}" />" class="thumb"><img src="${orderGoodsSetList.goodsDispImgC}" alt="${orderGoodsSetList.goodsNm}" /></a>
                                           <div class="thumb-etc">
                ...
                <div class="btn_wrap">
                    <a href="javascript:void(0);" onclick="nonmember_move_page('${so.ordNo}', '${so.nonOrdrMobile}',${so.schGbCd});" class="btn bd">목록</a>
                </div>
            </section>
