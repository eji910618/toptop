...
<t:insertDefinition name="defaultLayout">
    ...
    <t:putAttribute name="style">
        ...
        <link rel="stylesheet" href="/front/css/projectm/main.css?v=2">
    </t:putAttribute>
		        ...
		        <section class="main_magazine">
                    ...
                    <ul>
                        <c:forEach var="item" items="${magazineBanner.resultList}" varStatus="status">
                            ...
                            <li>
                                <a href="${visualLinkUrl}" ${visualTarget}>
                                    <img src="<spring:eval expression="@system['system.cdn.path']" />/${item.partnerId}/image/banner/${item.filePath1}/${item.fileNm1}?AR=0&RS=590x379" alt="">
                                </a>
                                <span class="txts">
