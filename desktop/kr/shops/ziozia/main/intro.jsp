...
<head>
    ...
    <link rel="stylesheet" href="/front/css/ziozia/default.css">
...
<section class="intro_rolling">
    ...
    <div class="intro_visual">
        <ul class="bxslider slides">
            <li>
                <div class="visual" style="background-image:url(https://www.topten10mall.com/image/ost/ziozia/intro/intro_visual01.jpg)"></div>
                <!-- <div class="txt_area">
                    <p><img src="/front/img/ziozia/main/img_logo.png" alt="ZIOZIA"></p>
                </div> -->
            </li>
            <li>
                <div class="visual" style="background-image:url(https://www.topten10mall.com/image/ost/ziozia/intro/intro_visual02.jpg)"></div>
                <!-- <div class="txt_area">
                    <p><img src="/front/img/ziozia/main/img_logo.png" alt="ZIOZIA"></p>
                </div> -->
            </li>
            <li>
                <div class="visual" style="background-image:url(https://www.topten10mall.com/image/ost/ziozia/intro/intro_visual03.jpg)"></div>
                <!-- <div class="txt_area">
                    <p><img src="/front/img/ziozia/main/img_logo.png" alt="ZIOZIA"></p>
                </div> -->
            </li>
