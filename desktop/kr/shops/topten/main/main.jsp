...
<t:insertDefinition name="defaultLayout">
    ...
    <t:putAttribute name="style">
        ...
        <link rel="stylesheet" href="/front/css/topten/main.css?v=2">
    </t:putAttribute>
    ...
    <t:putAttribute name="content">
        ...
        <section id="container">
            ...
            <section class="main_feature">
                <div class="man">
                	<div class="title_h2"><span>MD&rsquo;S PICK</span></div>
                	<div class="rolling">
	                    <ul>
	                        <li><a href="#" class="on">MAN</a></li>
...
<!-- 	                        <li><a href="#">MD&rsquo;S PICK</a></li> -->
	                ...
	                <div class="thumbnail-list">
	                    <ul>
	                        <data:goodsList value="${mensGoods}" partnerId="${_STORM_PARTNER_ID}" loopCnt="5"/>
	                        <data:goodsList value="${casualGoods}" partnerId="${_STORM_PARTNER_ID}" loopCnt="5"/>
<%-- 	                        <data:goodsList value="${mdsPickGoods}" partnerId="${_STORM_PARTNER_ID}" loopCnt="5"/> --%>
            ...
            <!-- magazine -->
	        <section class="main_magazine" style="padding-top: 62px;">
	            <c:if test="${!empty magazineBanner.resultList}">
                    ...
                    <ul>
                        <c:forEach var="item" items="${magazineBanner.resultList}" varStatus="status">
                            ...
                            <li>
                                <a href="${visualLinkUrl}" ${visualTarget}>
                                    <img src="<spring:eval expression="@system['system.cdn.path']" />/${item.partnerId}/image/banner/${item.filePath1}/${item.fileNm1}?AR=0&RS=590x406" alt="">

	                                <span class="txts">
	                                    <span>${item.mainBannerWords1}</span>
	                                    <p style="color: #A6A6A6">${item.mainBannerWords2}</p><br/>
	                                    ${item.mainBannerWords3}
	                                </span>
	                                <span class="txts2">자세히 보기&gt;</span>
                                </a>
                            </li>
                        </c:forEach>
                    </ul>
            ...
            <section class="main_video">
                <div class="video_inner">
                    <div>
                        <h2 class="title_h2"><span>SEASON CONCEPT</span></h2>
                    </div>
                    <c:forEach var="item" items="${seasonConceptBanner.resultList}" end="1" varStatus="status">
                        <h2 class="pb35"><c:if test="${status.index eq 0 }"><i>${item.bannerNm}</i></c:if></h2>
                        <c:choose>
