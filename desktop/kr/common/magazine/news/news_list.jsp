...
<t:insertDefinition name="defaultLayout">
    <t:putAttribute name="title">NEWS</t:putAttribute>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $('.more_view').on('click', function() {
                    ...
                    var url = Constant.uriPrefix + '/front/magazine/newsList.do?'+param;
            ...
            <div id="magazine" class="inner">
                <form:form id="form_id_search" commandName="so">
                    ...
                    <c:if test="${!empty hotzoneBanner.data}">
                        <div class="hot_wrap">
                            <div><a href="${_MALL_PATH_PREFIX}/front/magazine/newsView.do?dispBannerNo=${hotzoneBanner.data.dispBannerNo}"><img src="<spring:eval expression="@system['system.cdn.path']" />/${hotzoneBanner.data.partnerId}/image/magazine/${hotzoneBanner.data.hotzoneListImgPath1}/${hotzoneBanner.data.hotzoneListImgNm1}" alt=""></a></div>
                            <div>
                                <span class="cate"><c:if test="${site_info.partnerNo eq 0}">${hotzoneBanner.data.partnerNm} / </c:if>NEWS</span>
                                <span class="tit">
                                    <a href="${_MALL_PATH_PREFIX}/front/magazine/newsView.do?dispBannerNo=${hotzoneBanner.data.dispBannerNo}">
                            ...
                            <c:forEach var="item" items="${newList.resultList}" varStatus="status">
                                <li>
                                    <a href="${_MALL_PATH_PREFIX}/front/magazine/newsView.do?dispBannerNo=${item.dispBannerNo}">
                                        <img src="<spring:eval expression="@system['system.cdn.path']" />/${item.partnerId}/image/magazine/${item.filePath1}/${item.fileNm1}?AR=0&RS=374x257" alt="">
