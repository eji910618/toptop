                                        ...
                                        <c:forEach var="bbsList" items="${resultListModel.resultList}" varStatus="status">
                                            ...
                                            <c:choose>
                                                <c:when test="${bbsList.imgFilePath ne null}">
                                                    <%--<c:set var="bbsImg" value="<img src='/image/v.do?type=BBS&path=${bbsList.imgFilePath}&id1=${bbsList.imgFileNm}'  width='65px' height='65px' alt=''>"/>--%>
                                                    <c:set var="bbsImg" value="<img src='/image/bbs/${bbsList.imgFilePath}/${bbsList.imgFileNm}'  width='65px' height='65px' alt=''>"/>
                                                </c:when>
                                                <c:otherwise>
